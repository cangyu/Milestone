...
###deque
&emsp;Here the deque was implemented based on ___Block List___, which combines the advantages of vector and list and provides ___$O(sqrt(n))$___ performance for ___search___, ___insert___ and ___erase___ operations.  
